...
class ThemeTokenTests(SimpleTestCase):
    ...
    def test_participant_assignment_form_layout_is_balanced(self):
        ...
        self.assertIn('class="field participant-assignment-active-field"', template)
        self.assertIn("Active assignment", template)
        self.assertIn('field_class="participant-assignment-notes-field"', template)
        self.assertLess(template.index('field=form.notes'), template.index('class="field participant-assignment-active-field"'))
        self.assertIn(".participant-assignment-grid", css)
        self.assertIn(".participant-assignment-active-control", css)
        self.assertIn("border-left: 3px solid var(--brand);", css)
        self.assertIn(".participant-assignment-notes-field", css)
        self.assertIn(".participant-assignment-active-field {\n  grid-column: 1 / -1;", css)
    ...
    def test_participant_assigned_worker_actions_align_inline(self):
        ...
        self.assertIn("min-width: 18rem;", css)
        self.assertIn("text-align: center;", css)
        self.assertIn(".related-records-table .assignment-end-form", css)
        self.assertIn("width: 100%;", css)
        self.assertIn("justify-content: center;", css)
        self.assertIn(".related-records-table .assignment-ended-action", css)
    ...
    def test_admin_document_manager_polish_assets_exist(self):
        ...
        self.assertIn(".document-directory-filter", css)
        self.assertIn(".document-directory-table", css)
        self.assertIn(".document-person-hero", css)
        self.assertIn(".document-person-meta", css)
        self.assertIn(".document-file-filter", css)
        ...
        self.assertIn("  min-width: max-content;\n}", css)
        ...
        self.assertIn(".document-directory-filter,\n  .document-file-filter", css)
        self.assertIn('class="card document-directory-panel"', template)
        self.assertIn('class="filter-bar document-directory-filter"', template)
        self.assertIn('class="document-directory-table"', template)
        self.assertIn('class="document-owner-switch"', template)
        self.assertIn("Open files", template)
        self.assertIn("Upload File", template)
