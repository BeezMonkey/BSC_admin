...
class SupportWorkerManagementTests(TestCase):
    ...
    def test_worker_detail_shows_compliance_document_upload_statuses(self):
        ...
        self.assertContains(response, 'data-upload-required-type="ndis_worker_screening"')
        self.assertContains(response, 'data-upload-title="NDIS Worker Screening Check"')
